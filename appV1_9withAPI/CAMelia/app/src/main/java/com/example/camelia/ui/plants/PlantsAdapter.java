...
public class PlantsAdapter extends RecyclerView.Adapter<PlantsAdapter.ViewHolder>{
    ...
    PlantsAdapter.OnListItemClickListener listener;

    public PlantsAdapter (List<Plant> plantList, PlantsAdapter.OnListItemClickListener listener){
    ...
    @NotNull
    @Override
    public PlantsAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view =inflater.inflate(R.layout.search_item, parent, false);
        return new PlantsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull PlantsAdapter.ViewHolder holder, int position) {
